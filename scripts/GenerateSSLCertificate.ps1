...
& "$ToolsPath\makecert.exe" -r -pe -n "CN=DO_NOT_TRUST_Local Development CA" -cy authority -a sha256 -l 2048 -sky signature -# 2 -sv $SSLCAPrivateKeyPath $SSLCACertificatePath
